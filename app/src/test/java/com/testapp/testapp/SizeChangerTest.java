...
public class SizeChangerTest {
    ...
    public void zoomInUpperRoundTest(){
        int expected = 5860;
        int actual = SizeChanger.zoomIn(586, Constants.SCALE);
    ...
    public void zoomInLowerRoundTest(){
        int expected = 5940;
        int actual = SizeChanger.zoomIn(594, Constants.SCALE);
        assertEquals(expected, actual);
    }
    ...
    public void zoomOutUpperRoundTest(){
        int expected = 59;
        int actual = SizeChanger.zoomOut(589, Constants.SCALE);
        assertEquals(expected, actual);
    }
    ...
    public void zoomOutLowerRoundTest(){
        int expected = 59;
        int actual = SizeChanger.zoomOut(594, Constants.SCALE);
        assertEquals(expected, actual);
    }
